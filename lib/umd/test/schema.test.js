...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "assert", "../services/jsonSchemaService", "../parser/jsonParser", "fs", "url", "path", "../jsonLanguageService", "../jsonLanguageTypes"], factory);
    }
})(function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var assert = require("assert");
    var SchemaService = require("../services/jsonSchemaService");
    var Parser = require("../parser/jsonParser");
    var fs = require("fs");
    var url = require("url");
    var path = require("path");
    var jsonLanguageService_1 = require("../jsonLanguageService");
    var jsonLanguageTypes_1 = require("../jsonLanguageTypes");
    function toDocument(text, config, uri) {
        if (uri === void 0) { uri = 'foo://bar/file.json'; }
        var textDoc = jsonLanguageService_1.TextDocument.create(uri, 'json', 0, text);
    ...
    suite('JSON Schema', function () {
        ...
        test('Resolving $refs', function () {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    service = new SchemaService.JSONSchemaService(newMockRequestService(), workspaceContext);
        ...
        test('Schema matching', function () {
            return __awaiter(this, void 0, void 0, function () {
                var ls, positives, negatives, _i, positives_2, positive, doc, ms, _a, negatives_2, negative, doc, ms;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            ls = jsonLanguageService_1.getLanguageService({ workspaceContext: workspaceContext });
                            ls.configure({ schemas: [{ uri: 'http://myschemastore/myschemabar', fileMatch: ['*.foo.json'], schema: { type: 'object', required: ['foo'] } }] });
                            positives = ['file://folder/a.foo.json', 'file://folder/a.foo.json?f=true', 'file://folder/a.foo.json#f=true'];
                            negatives = ['file://folder/a.bar.json', 'file://folder/foo?a.foo.json', 'file://folder/foo#a.foo.json'];
                            _i = 0, positives_2 = positives;
                            _b.label = 1;
                        case 1:
                            if (!(_i < positives_2.length)) return [3 /*break*/, 4];
                            positive = positives_2[_i];
                            doc = toDocument("{}", undefined, positive);
                            return [4 /*yield*/, ls.getMatchingSchemas(doc.textDoc, doc.jsonDoc)];
                        case 2:
                            ms = _b.sent();
                        ...
                        case 3:
                            ...
                            return [3 /*break*/, 1];
                        case 4:
                            _a = 0, negatives_2 = negatives;
                            _b.label = 5;
                        case 5:
                            if (!(_a < negatives_2.length)) return [3 /*break*/, 8];
                            negative = negatives_2[_a];
                            doc = toDocument("{}", undefined, negative);
                            return [4 /*yield*/, ls.getMatchingSchemas(doc.textDoc, doc.jsonDoc)];
                        case 6:
                            ms = _b.sent();
        ...
        test('$ref in $ref, avoid clearing too early', function () {
            return __awaiter(this, void 0, void 0, function () {
                var aSchemaUri, aSchema, bSchemaUri, bSchema, aUri, a, textDocument, jsonLanguageService, jsonDocument, offset1, pos1, hover;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            aSchemaUri = 'internal://schema/a.json';
                            aSchema = {
                            ...
                            bSchemaUri = 'internal://schema/b.json';
                            bSchema = {
                                type: "object",
                                properties: {
                                    props: {
                            ...
                            aUri = 'foo://server/a.data.json';
                            a = "{\n\t\t\t\"props\": {\n\t\t\t\t\"kind\": \"feedback\",\n\t\t\t\t\"feedback\": {\n\t\t\t\t\t\"modalProps\": {\n\t\t\t\t\t\t\"content\": {\n\t\t\t\t\t\t\t\"props\"/*1*/: {\n\t\t\t\t\t\t\t}\n\t\t\t\t\t\t},\n\t\t\t\t\t\t\"compareToThis\": {\n\t\t\t\t\t\t\t\"props\"/*2*/: {\n\t\t\t\t\t\t\t\t\"kind\": \"feedback\",\n\t\t\t\t\t\t\t\t\"feedback\": {\n\t\t\t\t\t\t\t\t\t\"modalProps\": {\n\t\t\t\t\t\t\t\t\t\t\"content\": \" 1\"\n\t\t\t\t\t\t\t\t\t}\n\t\t\t\t\t\t\t\t}\n\t\t\t\t\t\t\t}\n\t\t\t\t\t\t},\n\t\t\t\t\t\tC: \"1\"\n\t\t\t\t\t}\n\t\t\t\t},\n\t\t\t\tthen: {\n\t\t\t\t\tkind: \"other\"\n\t\t\t\t}\n\t\t\t}\n\t\t}";
                            textDocument = jsonLanguageService_1.TextDocument.create(aUri, 'json', 1, a);
                            jsonLanguageService = jsonLanguageService_1.getLanguageService({
                            ...
                            offset1 = textDocument.getText().indexOf('/*1*/') - 1;
                            pos1 = textDocument.positionAt(offset1);
                            return [4 /*yield*/, jsonLanguageService.doHover(textDocument, pos1, jsonDocument)];
                        case 1:
                            hover = _a.sent();
                            assert.deepEqual(hover === null || hover === void 0 ? void 0 : hover.contents, [jsonLanguageTypes_1.MarkedString.fromPlainText('A')]);
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            ...
                            ls = jsonLanguageService_1.getLanguageService({ workspaceContext: workspaceContext, schemaRequestService: schemaRequestService });
        ...
        test('getMatchingSchemas', function () {
            return __awaiter(this, void 0, void 0, function () {
                function assertMatchingSchema(ms, nodeOffset, comment) {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            ls = jsonLanguageService_1.getLanguageService({ workspaceContext: workspaceContext });
                            testDoc = toDocument(JSON.stringify({ foo: { bar: 1, baz: true } }));
                            return [4 /*yield*/, ls.getMatchingSchemas(testDoc.textDoc, testDoc.jsonDoc, schema)];
                        case 1:
                            ms = _a.sent();
        ...
        test('schema resolving severity', function () {
            return __awaiter(this, void 0, void 0, function () {
                var schema, ls, _a, textDoc, jsonDoc, resolveError, _b, textDoc, jsonDoc, resolveError;
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        case 0:
                            ...
                            ls = jsonLanguageService_1.getLanguageService({});
                            _a = toDocument(JSON.stringify('SimpleJsonString')), textDoc = _a.textDoc, jsonDoc = _a.jsonDoc;
                            assert.strictEqual(jsonDoc.syntaxErrors.length, 0);
                            return [4 /*yield*/, ls.doValidation(textDoc, jsonDoc, { schemaRequest: 'error' }, schema)];
                        case 1:
                            resolveError = _c.sent();
                            assert.strictEqual(resolveError.length, 1);
                            assert.strictEqual(resolveError[0].severity, jsonLanguageTypes_1.DiagnosticSeverity.Error);
                            _b = toDocument(JSON.stringify('SimpleJsonString')), textDoc = _b.textDoc, jsonDoc = _b.jsonDoc;
                            assert.strictEqual(jsonDoc.syntaxErrors.length, 0);
                            return [4 /*yield*/, ls.doValidation(textDoc, jsonDoc, {}, schema)];
                        case 2:
                            resolveError = _c.sent();
                            assert.strictEqual(resolveError.length, 1);
                            assert.strictEqual(resolveError[0].severity, jsonLanguageTypes_1.DiagnosticSeverity.Warning);
                            return [2 /*return*/];
                    }
                });
            });
        });
        test('schema with severity', function () {
            return __awaiter(this, void 0, void 0, function () {
                var schema, ls, _a, textDoc, jsonDoc, semanticErrors, _b, textDoc, jsonDoc, semanticErrors, _c, textDoc, jsonDoc, semanticErrors, _d, textDoc, jsonDoc, semanticErrors;
                return __generator(this, function (_e) {
                    switch (_e.label) {
                        case 0:
                            ...
                            ls = jsonLanguageService_1.getLanguageService({});
                            _a = toDocument('{ "depr": "" }'), textDoc = _a.textDoc, jsonDoc = _a.jsonDoc;
                            assert.strictEqual(jsonDoc.syntaxErrors.length, 0);
                            return [4 /*yield*/, ls.doValidation(textDoc, jsonDoc, { schemaValidation: 'error' }, schema)];
                        case 1:
                            semanticErrors = _e.sent();
                            assert.strictEqual(semanticErrors.length, 5);
                            assert.strictEqual(semanticErrors[0].severity, jsonLanguageTypes_1.DiagnosticSeverity.Error);
                            assert.strictEqual(semanticErrors[1].severity, jsonLanguageTypes_1.DiagnosticSeverity.Error);
                            assert.strictEqual(semanticErrors[2].severity, jsonLanguageTypes_1.DiagnosticSeverity.Error);
                            assert.strictEqual(semanticErrors[3].severity, jsonLanguageTypes_1.DiagnosticSeverity.Error);
                            assert.strictEqual(semanticErrors[4].severity, jsonLanguageTypes_1.DiagnosticSeverity.Warning);
                            _b = toDocument('{"name": "", "age": -1, "address": "SA42", "email": "wrong_mail"}'), textDoc = _b.textDoc, jsonDoc = _b.jsonDoc;
                            assert.strictEqual(jsonDoc.syntaxErrors.length, 0);
                            return [4 /*yield*/, ls.doValidation(textDoc, jsonDoc, { schemaValidation: 'warning' }, schema)];
                        case 2:
                            semanticErrors = _e.sent();
                            assert.strictEqual(semanticErrors.length, 4);
                            assert.strictEqual(semanticErrors[0].severity, jsonLanguageTypes_1.DiagnosticSeverity.Warning);
                            assert.strictEqual(semanticErrors[1].severity, jsonLanguageTypes_1.DiagnosticSeverity.Warning);
                            assert.strictEqual(semanticErrors[2].severity, jsonLanguageTypes_1.DiagnosticSeverity.Warning);
                            assert.strictEqual(semanticErrors[3].severity, jsonLanguageTypes_1.DiagnosticSeverity.Warning);
                            _c = toDocument('{"name": "", "age": -1, "address": "SA42", "email": "wrong_mail"}'), textDoc = _c.textDoc, jsonDoc = _c.jsonDoc;
                            assert.strictEqual(jsonDoc.syntaxErrors.length, 0);
                            return [4 /*yield*/, ls.doValidation(textDoc, jsonDoc, { schemaValidation: 'ignore' }, schema)];
                        case 3:
                            semanticErrors = _e.sent();
                            assert.strictEqual(semanticErrors.length, 0);
                            _d = toDocument('{"name": "Alice", "age": 23, "address": "Solarstreet 42", "email": "alice@foo.com"}'), textDoc = _d.textDoc, jsonDoc = _d.jsonDoc;
                            assert.strictEqual(jsonDoc.syntaxErrors.length, 0);
                            return [4 /*yield*/, ls.doValidation(textDoc, jsonDoc, {}, schema)];
                        case 4:
                            semanticErrors = _e.sent();
