...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "assert", "../jsonLanguageService"], factory);
    }
    ...
    suite('JSON Hover', function () {
        function testComputeInfo(value, schema, position, serviceParams) {
            var uri = 'test://test.json';
            var schemaUri = "http://myschemastore/test1";
            if (!serviceParams) {
                serviceParams = { schemaRequestService: requestService };
            }
            var service = jsonLanguageService_1.getLanguageService(serviceParams);
            service.configure({ schemas: [{ fileMatch: ["*.json"], uri: schemaUri, schema: schema }] });
            var document = jsonLanguageService_1.TextDocument.create(uri, 'json', 0, value);
            var jsonDoc = service.parseJSONDocument(document);
                    ...
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, testComputeInfo(content, schema, { line: 0, character: 0 }).then(function (result) {
                                    assert.deepEqual(result.contents, [jsonLanguageService_1.MarkedString.fromPlainText('a very special object')]);
                                })];
                        case 1:
                            _a.sent();
                            return [4 /*yield*/, testComputeInfo(content, schema, { line: 0, character: 1 }).then(function (result) {
                                    assert.deepEqual(result.contents, [jsonLanguageService_1.MarkedString.fromPlainText('A')]);
                                })];
                        case 2:
                            _a.sent();
                            return [4 /*yield*/, testComputeInfo(content, schema, { line: 0, character: 32 }).then(function (result) {
                                    assert.deepEqual(result.contents, [jsonLanguageService_1.MarkedString.fromPlainText('C')]);
                                })];
                        case 3:
                            _a.sent();
                    ...
                    switch (_a.label) {
                        ...
                        case 2:
                            ...
                            return [4 /*yield*/, testComputeInfo(content, schema, { line: 0, character: 10 }).then(function (result) {
                                    assert.deepEqual(result.contents, [jsonLanguageService_1.MarkedString.fromPlainText('B\n\nIt\'s B')]);
                                })];
                        case 3:
                            _a.sent();
                            return [2 /*return*/];
        ...
        test('Contribution descriptions', function () {
            return __awaiter(this, void 0, void 0, function () {
                var serviceParams, result;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            serviceParams = {
                                contributions: [{
                                        getInfoContribution: function (uri, location) {
                                            return __awaiter(this, void 0, void 0, function () {
                                                return __generator(this, function (_a) {
                                                    return [2 /*return*/, [uri + ": " + location.join('/')]];
                                                });
                                            });
                                        },
                                        collectDefaultCompletions: function (uri, results) {
                                            return Promise.resolve();
                                        },
                                        collectPropertyCompletions: function (uri, location, currentWord, addValue, isLast, results) {
                                            return Promise.resolve();
                                        },
                                        collectValueCompletions: function (uri, location, propertyKey, results) {
                                            return Promise.resolve();
                                        }
                                    }]
                            };
                            return [4 /*yield*/, testComputeInfo('{ "prop1": [ 1, false ] }', {}, { line: 0, character: 3 }, serviceParams)];
                        case 1:
                            result = _a.sent();
                            assert.deepEqual(result.contents, ['test://test.json: prop1']);
                            return [4 /*yield*/, testComputeInfo('{ "prop1": [ 1, false ] }', {}, { line: 0, character: 13 }, serviceParams)];
                        case 2:
                            result = _a.sent();
