...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "assert", "../parser/jsonParser", "../services/jsonSchemaService", "../services/jsonHover", "../jsonLanguageService"], factory);
    }
    ...
    suite('JSON Hover', function () {
        function testComputeInfo(value, schema, position) {
            ...
            var hoverProvider = new jsonHover_1.JSONHover(schemaService, [], Promise);
