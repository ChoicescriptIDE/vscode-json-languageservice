...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "../jsonLanguageService", "assert"], factory);
    }
    ...
    suite('JSON Formatter', function () {
        var ls = jsonLanguageService_1.getLanguageService({ clientCapabilities: jsonLanguageService_1.ClientCapabilities.LATEST });
        function format(unformatted, expected, insertSpaces) {
            ...
            if (rangeStart !== -1 && rangeEnd !== -1) {
                ...
                var unformattedDoc = jsonLanguageService_1.TextDocument.create(uri, 'json', 0, unformatted);
                var startPos = unformattedDoc.positionAt(rangeStart);
                var endPos = unformattedDoc.positionAt(rangeEnd);
                range = jsonLanguageService_1.Range.create(startPos, endPos);
            }
            var document = jsonLanguageService_1.TextDocument.create(uri, 'json', 0, unformatted);
