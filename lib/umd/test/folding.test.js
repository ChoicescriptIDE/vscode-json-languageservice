...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "mocha", "assert", "../jsonLanguageService"], factory);
    }
    ...
    function assertRanges(lines, expected, nRanges) {
        var document = jsonLanguageService_1.TextDocument.create('test://foo/bar.json', 'json', 1, lines.join('\n'));
        var actual = jsonLanguageService_1.getLanguageService({}).getFoldingRanges(document, { rangeLimit: nRanges });
        var actualRanges = [];
