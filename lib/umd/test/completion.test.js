...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "assert", "../jsonLanguageService", "../utils/strings"], factory);
    }
    ...
    var applyEdits = jsonLanguageService_1.TextDocument.applyEdits;
    var assertCompletion = function (completions, expected, document, offset) {
        ...
        if (expected.resultText !== undefined && match.textEdit !== undefined) {
            var edit = jsonLanguageService_1.TextEdit.is(match.textEdit) ? match.textEdit : jsonLanguageService_1.TextEdit.replace(match.textEdit.replace, match.textEdit.newText);
    ...
    suite('JSON Completion', function () {
        var testCompletionsFor = function (value, schema, expected, clientCapabilities) {
            if (clientCapabilities === void 0) { clientCapabilities = jsonLanguageService_1.ClientCapabilities.LATEST; }
            var offset = value.indexOf('|');
            value = value.substr(0, offset) + value.substr(offset + 1);
            var ls = jsonLanguageService_1.getLanguageService({ clientCapabilities: clientCapabilities });
            if (schema) {
                ls.configure({
                    schemas: [{
            ...
            var document = jsonLanguageService_1.TextDocument.create('test://test/test.json', 'json', 0, value);
            var position = jsonLanguageService_1.Position.create(0, offset);
        ...
        test('Complete propertyNames', function () {
            return __awaiter(this, void 0, void 0, function () {
                var schema;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, testCompletionsFor('{"enum":{|}}', schema, {
                                    count: 2,
                                    items: [
                        ...
                        case 1:
                            _a.sent();
                            return [4 /*yield*/, testCompletionsFor('{"const":{"|', schema, {
                                    count: 1,
                                    items: [
                        ...
                        case 2:
                            _a.sent();
                            return [4 /*yield*/, testCompletionsFor('{"descriptions":{|}}', schema, {
                                    count: 3,
                                    items: [
                        ...
                        case 3:
                            _a.sent();
                            return [4 /*yield*/, testCompletionsFor('{"doNotSuggest":{|}}', schema, {
                                    items: [
                        ...
                        case 4:
                            _a.sent();
                            return [4 /*yield*/, testCompletionsFor('{"suggestSortText":{|}}', schema, {
                                    count: 1,
                                    items: [
                        ...
                        case 5:
                            _a.sent();
                            return [4 /*yield*/, testCompletionsFor('{"deprecation":{|}}', schema, {
                                    count: 1,
                                    items: [
                                        { label: 'a', notAvailable: true },
        ...
        test('Sanititize', function () {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            longLabel = strings_1.repeat('abcd', 20);
                            schema = {
                                type: 'object',
                                properties: (_a = {
                                        'a\nb': {
        ...
        test('Default snippets for complex properties', function () {
            return __awaiter(this, void 0, void 0, function () {
                var schema;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, testCompletionsFor('{"property_test":|', schema, {
                                    items: [{ label: 'property snippet' }]
                                })];
                        case 1:
                            _a.sent();
                            return [4 /*yield*/, testCompletionsFor('{"pattern_test":|', schema, {
                                    items: [{ label: 'pattern snippet' }]
                                })];
                        case 2:
                            _a.sent();
                            return [4 /*yield*/, testCompletionsFor('{"additional_test":|', schema, {
